...
router.post("/offers", authenticate, authorize("admin", "manager"), validate(MarketingOfferSchema), MarketingController.createOffer);
router.put("/offers/:id", authenticate, authorize("admin", "manager"), validate(MarketingOfferSchema), MarketingController.updateOffer);
