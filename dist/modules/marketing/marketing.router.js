...
router.post("/subscribe", marketing_controller_1.MarketingController.subscribe);
// Admin routes
...
router.get("/subscribers", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)("admin", "manager", "seo manager", "seo.manage", "cms.manage"), marketing_controller_1.MarketingController.getSubscribers);
