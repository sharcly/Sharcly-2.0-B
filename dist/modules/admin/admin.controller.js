...
const resetPaymentGateway = async (req, res) => {
    try {
        const { id } = req.params;
        await admin_service_1.AdminService.resetPaymentGateway(id);
...
exports.resetPaymentGateway = resetPaymentGateway;
