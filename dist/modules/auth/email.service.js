...
exports.sendOtpEmail = exports.sendWelcomeCoupon = exports.sendPasswordResetEmail = exports.sendOrderStatusUpdate = exports.sendOrderConfirmation = exports.sendVerificationEmail = void 0;
...
const sendOrderConfirmation = async (email, orderDetails) => {
    if (!resend)
        return;
    try {
        const invoiceBuffer = await invoice_service_1.InvoiceService.generateInvoiceBuffer(orderDetails);
...
const sendOrderStatusUpdate = async (email, order) => {
    ...
    try {
        ...
        await resend.emails.send({
            ...
            attachments,
            html: baseTemplate("Order Status Updated", `
